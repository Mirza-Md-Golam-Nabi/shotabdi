        ...
        <div class="flex justify-between">
            <div>
                <x-filament::button icon="heroicon-o-arrow-left" size="sm" color="danger" tag="a"
                    href="{{ route('filament.admin.pages.stock-out-calculation-egg', ['date' => $date['prev_date']]) }}">
            ...
            <div>
                <x-filament::button icon="heroicon-o-arrow-right" size="sm" color="success" tag="a"
                    href="{{ route('filament.admin.pages.stock-out-calculation-egg', ['date' => $date['next_date']]) }}">
